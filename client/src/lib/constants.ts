...
export const SUPPORTED_CHAINS: Chain[] = [
  {
    ...
    name: 'Ethereum',
    symbol: 'ETH',
    rpcUrl: `https://mainnet.infura.io/v3/${import.meta.env.VITE_INFURA_API_KEY || 'YOUR_PROJECT_ID'}`,
  ...
  },
  {
    ...
    name: 'Polygon',
    symbol: 'MATIC',
    rpcUrl: `https://polygon-mainnet.infura.io/v3/${import.meta.env.VITE_INFURA_API_KEY || 'YOUR_PROJECT_ID'}`,
